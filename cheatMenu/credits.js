function getCreditsMenu(){
  list = [
    ...
    txt("Central Core by MiceLee", 8),
    txt("Central Core Hard by MiceLee", 8),
    txt("Catastrophic Core by haha0201 and Strat", 8),
    txt("Haunted Halls by MiceLee", 8),
    txt("Mysterious Mansion by PotatoNuke", 8),
    txt("Coupled Corridors by Kaluub", 8),
    txt("Peculiar Pyramid by MiceLee", 8),
    txt("Peculiar Pyramid Hard by PotatoNuke", 8),
    txt("Shifting Sands by Piger and DD1", 8),
    txt("Dusty Depths by Piger and MeguclOwUn", 8),
    txt("Wacky Wonderland by MiceLee", 8),
    txt("Glacial Gorge by MiceLee", 8),
    txt("Glacial Gorge Hard originally by TTTruck", 8),
    txt("Vicious Valley by MiceLee", 8),
    txt("Vicious Valley Hard by Strat", 8),
    txt("Humongous Hollow by TTTruck and Gianni", 8),
    txt("Humongous Hollow Hard by PotatoNuke", 8),
    txt("Elite Expanse by MiceLee", 8),
    txt("Elite Expanse Hard by TTTruck and PotatoNuke", 8),
    txt("Endless Echo by PotatoNuke", 8),
    txt("Endless Echo Hard by Kaluub", 8),
    txt("Dangerous District by MiceLee", 8),
    ...
    txt("Monumental Migration by MiceLee", 8),
    txt("Monumental Migration Hard by Kaluub", 8),
    txt("Ominous Occult by MiceLee", 8),
    txt("Frozen Fjord by Stovoy", 8),
    ...
    txt("Toxic Territory by TTTruck", 8),
    txt("Toxic Territory Hard by TTTruck", 8),
    txt("Magnetic Monopole by TTTruck", 8),
    txt("Magnetic Monopole Hard by TTTruck", 8),
    txt("Burning Bunker by Extirpater", 8),
    txt("Burning Bunker Hard by TTTruck and Piger", 8),
    txt("Grand Garden by TTTruck", 8),
    txt("Grand Garden Hard by TTTruck", 8),
    txt("Cyber Castle by TTTruck", 8),
    txt("Cyber Castle Hard by PotatoNuke", 8),
    txt("Infinite Inferno by Kaluub", 8),
    txt("Withering Wasteland by PotatoNuke", 8),
    txt("Research Lab by TTTruck", 8),
    txt("Stellar Square by MiceLee", 8),
    txt("Assorted Alcove by TTTruck", 8),
    txt("Assorted Alcove Hard by TTTruck", 8),
    ...
    txt("Other maps created and balanced by Evades.io developers or dedicated Evades.io community members.", 8),
    pdd(0, 3000),
