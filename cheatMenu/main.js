  ...
  let list = [
    ...
    txt("Sandbox settings", 20), bigLine(),
        ...
        row([txt("Lighting quality:", 12), 
            btn("Low", null, 12, () => {lightMapDownsample = 16; lightMap = newLightMap()}, "Make dark areas have many less pixels. Only use if your framerate is tanking heavily."),
            btn("Medium", null, 12, () => {lightMapDownsample = 8; lightMap = newLightMap()}, "Make dark areas have less pixels. This is the default setting."),
            btn("Hight", null, 12, () => {lightMapDownsample = 4; lightMap = newLightMap()}, "Make dark areas have a medium amount of pixels."),]),
