  ...
  let list = [
    ...
    txt("Sandbox settings", 20), bigLine(),
        ...
        row([txt("Quality:", 12), 
            ...
            btn("Medium", null, 12, () => {pixelDensity(basePixelDensity / 2)}, "Make the game have a medium amount of pixels. This is the default setting."),
            btn("High", null, 12, () => {pixelDensity(basePixelDensity)}, "Make the game have more pixels."),]),
        row([txt("Lighting quality:", 12), 
            btn("Low", null, 12, () => {settings.lightMapDownsample = 16; lightMap = newLightMap()}, "Make dark areas have less pixels. Use if your framerate is tanking heavily in dark areas."),
            btn("Medium", null, 12, () => {settings.lightMapDownsample = 8; lightMap = newLightMap()}, "Make dark areas have a normal amount of pixels. This is the default setting."),
            btn("High", null, 12, () => {settings.lightMapDownsample = 4; lightMap = newLightMap()}, "Make dark areas have more pixels."),]),
    ...
    txt("Fun", 20), bigLine(),
      ...
      row([txt("Lights out:", 12), 
        tog(11, 11, false, () => {settings.nightMode = true}, () => {settings.nightMode = false}, undefined, "Makes every area have minimum lighting."),]),
      row([txt("Bioluminescence:", 12), 
        tog(11, 11, false, () => {settings.allGlowMode = true}, () => {settings.allGlowMode = false}, undefined, "Makes all entities glow."),]),
