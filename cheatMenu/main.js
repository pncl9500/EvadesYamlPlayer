...
function setCheatMenuItems(){
  let list = [
    ...
    txt("Sandbox settings", 20), bigLine(),
        ...
        // row([txt("Lighting quality:", 12), 
        //     btn("Lowest", null, 12, () => {lightMapDownsample = 16; lightMap = createGraphics(ceil(windowWidth / lightMapDownsample), ceil(windowHeight / lightMapDownsample));}, "Make dark areas have many less pixels. Only use if your framerate is tanking heavily."),
        //     btn("Low", null, 12, () => {lightMapDownsample = 8; lightMap = createGraphics(ceil(windowWidth / lightMapDownsample), ceil(windowHeight / lightMapDownsample));}, "Make dark areas have less pixels."),
        //     btn("Medium", null, 12, () => {lightMapDownsample = 4; lightMap = createGraphics(ceil(windowWidth / lightMapDownsample), ceil(windowHeight / lightMapDownsample));}, "Make dark areas have a medium amount of pixels."),
        //     btn("High", null, 12, () => {lightMapDownsample = 2; lightMap = createGraphics(ceil(windowWidth / lightMapDownsample), ceil(windowHeight / lightMapDownsample));}, "Make dark areas have more pixels. This is the default setting."),
        //     btn("Ridiculous", null, 12, () => {lightMapDownsample = 1; lightMap = createGraphics(ceil(windowWidth / lightMapDownsample), ceil(windowHeight / lightMapDownsample));}, "Make dark areas have way too many pixels. Will undoubtedly lag the game."),]),
    ...
    txt("Fun", 20), bigLine(),
      ...
      //     btn("Ambient", null, 12, () => {lightMapDownsample = 192; lightMap = createGraphics(ceil(windowWidth / lightMapDownsample), ceil(windowHeight / lightMapDownsample));}, "Make dark areas have so few pixels it loops back around to looking cool."),]),
